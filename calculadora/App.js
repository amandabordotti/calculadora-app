    ...
    <View style={[styles.container, {backgroundColor: theme.bg}]}>
      ...
      <View style={styles.pad}>
        ...
        <View style={styles.row}>
          <CalcButton theme={theme} label="C" variant="num" onPress={() => onKey("C")} />
          <CalcButton theme={theme} label="+/-" variant="num" onPress={() => onKey("SIGN")} />
        ...
        {/* Linha 5 */}
        <View style={styles.row}>
          <CalcButton theme={theme} label="0" variant="num" onPress={() => onKey("0")} />
          <CalcButton theme={theme} label="." variant="num" onPress={() => onKey(".")} />
          <CalcButton theme={theme} label="=" variant="num" onPress={() => onKey("=")} />
        </View>
